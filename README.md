...
A simple web application to predict Insurance Premium, built using Flask and deployed on Heroku.
...
To View the Deployed Application, click on the link given below : Insurance Premium Prediction Web App - https://insurancepremium2022.herokuapp.com/
...
- **Insurance Prediction.ipynb** contains code to build and train a Machine learning model.
